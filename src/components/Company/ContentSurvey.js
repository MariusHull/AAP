...
const form = [
  {
    ...
    subTopics: [
      ...
      },
      {
        ...
        details:
          "Maintenir un niveau élevé d’attention ou rester vigi- lant pendant de longues périodes est particulière- ment difficile pour l’organisme. Selon les tâches, par exemple de surveillance ou de contrôle, cela peut occasionner chez les salariés de la fatigue, des baisses d’attention, mais aussi la crainte de com- mettre des erreurs ou des oublis dans leur travail."
      }
    ]
  },
  {
    ...
    subTopics: [
      {
        ...
        details:
          "Au-delà d’une certaine limite, la durée hebdoma- daire du travail s’avère dommageable pour la santé, quelle que soit la satisfaction qu’éprouve le salarié dans son travail. D’après les connaissances scien- tifiques actuelles, il serait raisonnable de ne pas dépasser 45 heures de travail par semaine."
      },
      {
        ...
        details:
          "Certains types d’horaires de travail ont des réper- cussions sur la santé physique et mentale des sa- lariés. C’est par exemple les cas du travail de nuit ou du travail en horaires alternants (3x8, 2x12...), des horaires décalés (particulièrement le soir et le week-end), des horaires fractionnés (11h-15h puis 18h-21h, par exemple) ou du travail sur appel (ab- sence d’horaire pré-établi)."
      },
      {
        name:
          "L'extension de la disponibilité en dehors des horaires de travail",
        ...
        details:
          "La disponibilité demandée aux salariés peut s’éten- dre au-delà de leurs horaires de travail (week-end, congés...). Elle limite les possibilités de récupéra- tion physique et mentale. De plus, elle empiète sur la vie personnelle des salariés."
      },
      {
        name:
          "La prévisibilité des horaires de travail et anticipation de leur changement",
        ...
        details:
          "L’incertitude envers les horaires de travail à effec- tuer, le caractère inopiné des changements dans les plannings horaires... ne facilitent pas l’orga- nisation de la vie personnelle. Ils rendent difficile toute prévision des activités extraprofessionnelles et obligent à des adaptations souvent coûteuses pour les salariés, par exemple s’ils ont à charge de jeunes enfants."
      },
      {
  ...
  },
  {
    ...
    subTopics: [
      ...
      },
      {
        ...
        details:
          "De manière générale, les situations de changement (stratégique, organisationnel, technologique...) sont génératrices de risques de surcharge (temps d’ap- prentissage et d’assimilation des changements), de remise en cause des compétences et d’atteinte au sens donné au travail."
      }
    ]
  }
];
...
export default class ContentSurvey extends Component {
  ...
  componentDidMount() {
    ...
    axios
      ...
      .then(r => {
        console.log(r.data.sites[this.props.siteIndex].populations[this.props.populationIndex], this.props.populationIndex);
        this.setState({
          sites: r.data.sites,
          topics: r.data.sites[this.props.siteIndex].populations[this.props.populationIndex].topics
        });
      });
  }
  ...
  save = () => {
    ...
    sites[this.props.siteIndex].populations[this.props.populationIndex].topics = topics;
    axios.defaults.headers.common["Authorization"] =
      "JWT " + localStorage.getItem("jwtToken");
    axios
